...
namespace GestionPedidos.Controllers
{
    public class CustomerTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerTypeID,CustomerTypeName")] CustomerType customerType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerTypeID,CustomerTypeName")] CustomerType customerType)
        {
            if (ModelState.IsValid)
            {
